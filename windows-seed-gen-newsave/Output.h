...
public:
     ...
     */
    explicit Output(const Map& map, const uint32_t amount_of_seeds_to_return = 10, const bool randomize = false) :
        map(map), randomize(randomize),
    ...
    long amount_of_seeds_to_return; //amount of results
